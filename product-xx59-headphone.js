...
fetch("./data.json")
  .then((res) => res.json())
  .then((actualdata) => {
    const item = actualdata.slice(1, 2);
            ...
            <div class="prd-features-content">
              ...
              <div class="prd-in-the-box">
                <h3>in the box</h3>
                   ...
                   <ul>
                  <li><span>${item[0].includes[0].quantity}x </span>${
      item[0].includes[0].item
    }</li>
                  <li><span>${item[0].includes[1].quantity}x </span>${
      item[0].includes[1].item
    }</li>
                  <li><span>${item[0].includes[2].quantity}x </span>${
      item[0].includes[2].item
    }</li>
                  <li><span>${item[0].includes[3].quantity}x </span>${
      item[0].includes[3].item
    }</li>
                </ul>
...
async function addTocart() {
  ...
  try {
    ...
    const item = actualData[1]; // Assuming only one item is being processed
